...
public class ReuseableMethods {
    ...
    public static String createUser(WebDriver oBrowser, Map<String, String> data){
        ...
        try{
            ...
            if(oBrowser.findElement(By.xpath(String.format(ObjectLocator.obj_UserName_Link, userName))).isDisplayed()){
    ...
    /************************
     * Method            : getexcelData()
     * Purpose           : This method reads the testdata from the excel file in the for of Map<String, String>
     * Parameters        : String excelFileName
